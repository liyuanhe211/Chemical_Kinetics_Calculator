...
class Ui_Eyring_Eq(object):
    def setupUi(self, Eyring_Eq):
        ...
        self.recalc_pushButton = QtWidgets.QPushButton(parent=Eyring_Eq)
        self.recalc_pushButton.setEnabled(False)
        self.recalc_pushButton.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        self.recalc_pushButton.setFont(font)
        self.recalc_pushButton.setObjectName("recalc_pushButton")
        self.horizontalLayout_4.addWidget(self.recalc_pushButton)
        self.gridLayout.addLayout(self.horizontalLayout_4, 7, 5, 1, 4)
        ...
        self.horizontalLayout_2.addWidget(self.reset_all_pushButton)
        self.batch_pushButton = QtWidgets.QPushButton(parent=Eyring_Eq)
        self.batch_pushButton.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        Eyring_Eq.setTabOrder(self.G_neq_lineEdit, self.energy_unit_comboBox)
        Eyring_Eq.setTabOrder(self.energy_unit_comboBox, self.temp_lineEdit)
        Eyring_Eq.setTabOrder(self.temp_lineEdit, self.sigma_lineEdit)
        Eyring_Eq.setTabOrder(self.sigma_lineEdit, self.kTST_lineEdit)
        ...
        Eyring_Eq.setTabOrder(self.total_time_lineEdit, self.time_unit_comboBox)
        Eyring_Eq.setTabOrder(self.time_unit_comboBox, self.calculate_pushButton)
        Eyring_Eq.setTabOrder(self.calculate_pushButton, self.recalc_pushButton)
        Eyring_Eq.setTabOrder(self.recalc_pushButton, self.reset_all_pushButton)
        Eyring_Eq.setTabOrder(self.reset_all_pushButton, self.batch_pushButton)
        Eyring_Eq.setTabOrder(self.batch_pushButton, self.clear_conc2_pushButton)
        ...
        Eyring_Eq.setTabOrder(self.clear_sigma_pushButton, self.clear_G_pushButton)
    ...
    def retranslateUi(self, Eyring_Eq):
        ...
        self.recalc_pushButton.setText(_translate("Eyring_Eq", "Recalculate"))
        self.recalc_pushButton.setShortcut(_translate("Eyring_Eq", "Ctrl+Shift+V"))
        ...
        self.batch_pushButton.setText(_translate("Eyring_Eq", "Batch"))
        self.batch_pushButton.setShortcut(_translate("Eyring_Eq", "Ctrl+Shift+R"))
        ...
        self.status_label_5.setText(_translate("Eyring_Eq", "<html><head/><body><p>Shortcut: [Reset All] - Ctrl+Shift+R, [Calculate] - Ctrl+Shift+C, [Recalculate] - Ctrl+Shift+V</p></body></html>"))
