...
Alternatively, you can download a release for Windows which has an executable packed with `Cx_Freeze` (I didn't have the interest to optimize it, so it's quite large).
